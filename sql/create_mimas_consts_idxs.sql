...
ALTER TABLE attr_group
  ADD CONSTRAINT pk_attr_group_id				PRIMARY KEY (attr_group_id)
...
ALTER TABLE attr_detail_group
  ADD CONSTRAINT pk_attr_detail_group_id			PRIMARY KEY (attr_detail_group_id)
...
ALTER TABLE attr_detail
  ADD CONSTRAINT pk_attr_detail_id				PRIMARY KEY (attr_detail_id)
...
ALTER TABLE array
  ADD CONSTRAINT pk_array_id					PRIMARY KEY (array_id)
...
--   ADD CONSTRAINT pk_array_feature_id				PRIMARY KEY (array_feature_id) DISABLE NOVALIDATE
...
CREATE UNIQUE INDEX ndx_un_type_name_ci				ON attr_group         (type, LOWER(name));
CREATE UNIQUE INDEX ndx_un_attr_name_ci				ON attribute          (is_attribute, LOWER(name));
CREATE UNIQUE INDEX ndx_un_factor_name_ci			ON attribute          (is_factor, LOWER(name));
CREATE UNIQUE INDEX ndx_un_attr_id_name_ci			ON attr_detail_group  (attribute_id, LOWER(name));
CREATE UNIQUE INDEX ndx_un_type_attr_id_name_ci			ON attr_detail        (type, attribute_id, LOWER(name));
...
CREATE UNIQUE INDEX ndx_un_design_name_ci			ON array              (LOWER(design_name));
...
ALTER TABLE lab
  ADD CONSTRAINT pk_lab_id					PRIMARY KEY (lab_id)
...
ALTER TABLE user_to_facility
  ADD CONSTRAINT pk_user_id_attr_detail_id			PRIMARY KEY (user_id, attr_detail_id)
...
CREATE UNIQUE INDEX ndx_un_name_ci_2				ON country          (LOWER(name));
CREATE UNIQUE INDEX ndx_un_name_ci_3				ON organization     (LOWER(name));
CREATE UNIQUE INDEX ndx_un_name_ci_4				ON lab              (LOWER(name));
CREATE UNIQUE INDEX ndx_un_pi_email_ci				ON lab              (LOWER(pi_email));
CREATE UNIQUE INDEX ndx_un_username_ci				ON mimas_user       (LOWER(username));
CREATE UNIQUE INDEX ndx_un_email_ci				ON mimas_user       (LOWER(email));
CREATE UNIQUE INDEX ndx_un_name_ci_5				ON mimas_group      (LOWER(name));
...
ALTER TABLE up_experiment
  ADD CONSTRAINT pk_experiment_id				PRIMARY KEY (experiment_id)
...
ALTER TABLE up_sample
  ADD CONSTRAINT pk_sample_id_2					PRIMARY KEY (sample_id)
...
ALTER TABLE up_sample_file
  ADD CONSTRAINT pk_sample_file_id				PRIMARY KEY (sample_file_id)
...
ALTER TABLE up_sample_attribute
  ADD CONSTRAINT pk_sample_attribute_id_2			PRIMARY KEY (sample_attribute_id)
...
ALTER TABLE up_exp_attribute
  ADD CONSTRAINT pk_exp_attribute_id				PRIMARY KEY (exp_attribute_id)
...
ALTER TABLE up_exp_factor
  ADD CONSTRAINT pk_experiment_id_factor_id			PRIMARY KEY (experiment_id, factor_id)
...
ALTER TABLE group_exp_privilege
  ADD CONSTRAINT pk_group_id_experiment_id			PRIMARY KEY (group_id, experiment_id)
...
/* CREATE UNIQUE INDEX ndx_un_sam_id_attr_id_chr_ci_2		ON up_sample_attribute  (sample_id, attribute_id, LOWER(char_value));      */
...
/* CREATE UNIQUE INDEX ndx_un_exp_id_attr_id_chr_ci		ON up_exp_attribute     (experiment_id, attribute_id, LOWER(char_value));  */
