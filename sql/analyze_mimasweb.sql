...
-- MIMAS Web
EXEC DBMS_UTILITY.ANALYZE_SCHEMA(schema => 'MIMAS_WEB', method => 'COMPUTE');
EXEC DBMS_UTILITY.ANALYZE_SCHEMA(schema => 'MIMAS_WEB', method => 'COMPUTE', method_opt => 'FOR ALL COLUMNS');
EXEC DBMS_STATS.GATHER_SCHEMA_STATS(ownname => 'MIMAS_WEB', cascade => TRUE);
